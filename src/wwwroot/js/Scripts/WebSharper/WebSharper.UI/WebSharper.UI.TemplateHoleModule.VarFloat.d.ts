import { CheckedInput_T } from "../../../Content/WebSharper/WebSharper.UI/WebSharper.UI.Client.CheckedInput`1"
...
export default class VarFloat extends TemplateHole {
  name:string;
  fillWith:Var<CheckedInput_T<number>>;
  get Value():Var<CheckedInput_T<number>>
  ...
  get ValueObj()
  get Name():string
  constructor(name:string, fillWith:Var<CheckedInput_T<number>>)
}
