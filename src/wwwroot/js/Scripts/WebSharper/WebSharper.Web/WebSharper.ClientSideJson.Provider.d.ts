...
export function DecodeSeq<T0>(decEl:(() => ((a:any) => T0))):(() => ((a:any) => (T0)[]))
export function DecodeArray<T0>(decEl:(() => ((a:any) => T0))):(() => ((a:any) => (T0)[]))
export function DecodeUnion<T0>(t:((a:any) => T0), discr, cases:([string, ([string, string, (() => ((a:any) => any)), number])[]])[]):(() => ((a:any) => T0))
export function DecodeClass<T0>(t:((a:any) => T0), fields:([string, (() => ((a:any) => any)), number])[], subClassDecoders:((() => ((a:any) => T0)))[]):(() => ((a:any) => T0))
export function DecodeRecord<T0>(t:((a:any) => T0), fields:([string, (() => ((a:any) => any)), number])[]):(() => ((a:any) => T0))
...
export function DecodeDateTimeOffset():(() => ((a:any) => {d:number,o:number}))
...
export function EncodeSeq<T0>(encEl:(() => ((a?:T0) => any))):(() => ((a:(T0)[]) => any))
...
export function EncodeDateTimeOffset():(() => ((a:{d:number,o:number}) => any))
