...
let clusterHost =
    let defaultValue = defaultParsed.GetResult(Cluster_Host, "127.0.0.1")
    overrideParsed
...
try
    ...
    printfn "Probe helpers sendEchoProbe(); sendRawEchoProbe \"--say \\\"text\\\" --set-count 1 --mode fast\"; sendPfcfProbe()"
