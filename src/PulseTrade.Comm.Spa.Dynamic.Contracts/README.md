...
let polarityOptions =
    TaHistogramTraceOptionsCodec.apply
        ...
        existingTraceOptions
```

theme未指定維持Light。Histogram兩色皆缺維持`TaTraceSpec.Color`；partial pair、invalid color或非Histogram使用這組options會被candidate validation拒絕。
