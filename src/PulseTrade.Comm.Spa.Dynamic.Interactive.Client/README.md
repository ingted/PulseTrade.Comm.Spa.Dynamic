...
Current exact package：`PulseTrade.Comm.Spa.Dynamic.Interactive.Client 0.1.0-alpha10`，exact依賴Contracts `[0.1.0-alpha17]`、Renderer `[0.1.0-alpha39]`與FSharp.Core `[10.1.400]`；bundle manifest版本須與nuspec一致。這是Daedalus production consumer唯一相容組。
