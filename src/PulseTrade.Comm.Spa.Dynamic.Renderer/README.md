...
- current exact package：`PulseTrade.Comm.Spa.Dynamic.Renderer 0.1.0-alpha49`，exact依賴Contracts `[0.1.0-alpha21]`與FSharp.Core `[10.1.400]`。Current model gate 25/25；高密度overview selection以不重疊的move/left-resize/right-resize hit-area保留三種操作。
