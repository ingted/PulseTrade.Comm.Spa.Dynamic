...
5. PTC RN `PTC3-063/066/065` 完成 controller-region restart redelivery、provider-bound completion 與 service-window proof 後，再把 `DYN-WBS-406` / `PTC3-067` 從 browser/runtime E2E 推進到 production split-service E2E。
