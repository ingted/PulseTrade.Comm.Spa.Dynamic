...
- `PulseTrade.Comm.Spa.Dynamic.Renderer 0.1.74` exact `Contracts [0.1.29]`
- `PulseTrade.Comm.Spa.Dynamic.Interactive.Client 0.1.65` exact `Contracts [0.1.29]`、`Renderer [0.1.74]`
...
- fresh source-identical WebSharper Release builds：Renderer `0.1.74`、Interactive.Client `0.1.65`、BrowserDemo全部成功。
- F# Playwright：fresh viewport 4,000；single/dense/empty OFI及overview contract通過；five-candle/scenario/All/marker/document/progressive max=`69.27/81.02/39.91/31.39/56.03/43.75ms`，acceptance phases `over100=0`。
- Interactive package verifier通過，bundle manifest與nuspec版本一致。
- Release SHA-256：沿用已凍結且未變更contract的Contracts `7A59C0A671E5E995B88D1BCD23F074D2ADC0280D6DFD9EC09C354208D51FFC9E`、Renderer `863A56E5404EF9E4586191C0FD6B23EC30A759FC5896E6090C19E98A3AAF9BEC`、Interactive.Client `4DA2B1908DBE9B7CFBF850294B63E3774E1A6E64CB81C00E1BCB205F7E372CDC`。Contracts同版後重打包的`A93F...`不得交付。
