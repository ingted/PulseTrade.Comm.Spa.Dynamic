...
| DYN-TA-003 | 4 | WebSharper TA renderer | rows, viewport, controls, status, bounded state | DYN-TA-001/002 | T-005..T-007,T-011,T-012,T-015 | 88% | Active | [@DYN-TA-003](WBS.DYN-TA-003.md) |
| DYN-TA-004 | 5 | PTCS compatibility adapter | isolated server adapter, authenticated callbacks, transient mapping, browser adapter | DYN-TA-001..003 + PTCS seam | T-007,T-010,T-013,T-016,T-017 | 74% | Active | [@DYN-TA-004](WBS.DYN-TA-004.md) |
