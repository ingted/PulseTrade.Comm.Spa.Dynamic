...
| DYN-TA-025 | 0 | Visible marker label／row-local cursor data window | marker可見文字、每列cursor日期時間、candlestick OHLCV／series value同源presentation | DYN-TA-023/024 + Daedalus marker label feedback | T-094..097 | 100% | Renderer owner gate完成；exact packages已發布，等Daedalus以真SPAA重跑consumer gate | [RFC-0022](../RFC/RFC-PTCS-DYNAMIC-0022.inline-marker-label-row-cursor-data-window.md) |
