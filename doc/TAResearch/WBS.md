...
| DYN-TA-025 | 0 | Visible marker label／row-local cursor data window | marker可見文字、每列cursor日期時間、candlestick OHLCV／series value同源presentation | DYN-TA-023/024 + Daedalus marker label feedback | T-094..097 | 100% | Immutable exact graph `Renderer 0.1.40 / Interactive.Client 0.1.33 / Ptcs.Client 0.1.56`已發布並由official-source-only isolated gates驗證；舊`0.1.39 / 0.1.32 / 0.1.55`不可作final consumer graph | [RFC-0022](../RFC/RFC-PTCS-DYNAMIC-0022.inline-marker-label-row-cursor-data-window.md) |
| DYN-TA-026 | 0 | Shared axis canonical event time | axis optional EventTimeUtc、legacy decode、renderer timeline/marker/cursor一致、exact graph | DYN-TA-017/025 + Daedalus correction | T-098..101 | 100% | Owner實作與official-source-only gates完成；final graph為Contracts `0.1.15`、Renderer `0.1.41`、Interactive.Client `0.1.35`、Dynamic.Ptcs `0.1.40`、Ptcs.Client `0.1.57`。真SPAA consumer gate由Daedalus接續。 | [RFC-0023](../RFC/RFC-PTCS-DYNAMIC-0023.shared-axis-canonical-event-time.md) |
