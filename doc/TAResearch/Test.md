...
| DYN-TA-T-062 | REQ-038..040 | Model/package/Playwright | add/remove/reconfigure不同參數row；pending/reject；1K+5K及5K+30K geometry、missing/partial/final/quality/availability。 | Partial pass：generic isolated Contracts 15/15、Renderer 22/22、PTCS 10/10、Ptcs.Client 12/12；Playwright desktop/mobile、pending/accept與console 0通過。Owner-normalized real DIB evidence併入T-063/064。 |
| DYN-TA-T-063 | REQ-041 | DIB integration | dedicated chart root auto-display，不攔截Expression/FloatingPoint/list formatter；`ApplyTemplate`由Daedalus controller authoritative prepare/swap/release；consumer可在`FSharp.Core 10.1.302` exact graph restore。 | Partial：Aster packages已改為Contracts alpha12 / Renderer alpha33 / Interactive.Client alpha4且nuspec鎖定`FSharp.Core [10.1.302]`；Daedalus real controller/DIB gate待續。 |
