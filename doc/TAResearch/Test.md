...
| DYN-TA-T-070 | REQ-050 | Capacity/package/browser | 3820 positions x 28 compact series serialized frame低於16MiB；working set上限4000；exact package、WebSharper、F# Playwright與Playwright MCP無OOM/console error。 | Partial：deterministic contract容量與五專案full build已Pass；package push與browser E2E待本slice收尾。 |
