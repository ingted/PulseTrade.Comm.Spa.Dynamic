...
| DYN-TA-T-073 | REQ-052..054 | Pure reducer | 只由accepted document/snapshot/patch建立entry；gap/error/reject不寫；rehydrate採current session identity，新snapshot可取代。 | Pass（pure slice）：heartbeat/gap不寫、rehydrate不消耗transport sequence、current session identity與authoritative snapshot replacement已覆蓋；browser handshake仍由T-075追蹤。 |
...
| DYN-TA-T-075 | REQ-053/054 | Client/WebSocket | cache hit先呈現last-good並恰送一次resume；miss送full；Accepted不改data；authoritative patch/full後READY且single channel/timer。 | Planned |
