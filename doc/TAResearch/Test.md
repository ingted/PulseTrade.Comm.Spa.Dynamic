...
| DYN-TA-T-100 | DYN-WBS-560 | Sparse heterogeneous browser performance | 4,000 bars x 7 rows含20條missing/sparse trace；same-topology candle replacement與`cursor=None` visible-value refresh不得有>100ms task；既有cursor/All/marker/document/progressive gates不回歸。 | Owner PASS：舊graph five-candle replacement 105.42ms／over100=1；Renderer `0.1.51` graph 74.01ms／over100=0。其餘phase max 26.56/8.18/38.59/53.25/28.39/44.94ms；focused 46/12/16。真3,820-bar SPAA consumer Pending。 |
