...
| DYN-TA-T-102 | DYN-WBS-561 | Selective temporal reducer performance | 4,000 bars中scenario overlay replacement不全掃unchanged K/TA；mixed authority replacement保持atomic；malformed/unknown position reason code與last-good不變。 | OWNER PASS：五個focused suites全通過；F# Playwright scenario overlay 82.19ms且over100=0。Final local candidate exact graph已建立，真SPAA selection gate pending。 |
