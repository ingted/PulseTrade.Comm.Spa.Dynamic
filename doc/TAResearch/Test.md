...
| DYN-TA-T-074 | REQ-052/054/055 | Browser storage | IndexedDB read/write/delete/LRU、8-entry bound、corrupt/quota/unavailable no-cache fallback；不保存credential/capability。 | Pass：純WebSharper fixture經Playwright驗證reload後count=8、latest hit、oldest evicted、exact-owner coverage hit/miss、clear=0且console error=0；quota/unavailable由typed fallback path與unit validation覆蓋。 |
