...
| DYN-TA-T-070 | REQ-050 | Capacity/package/browser | 3820 positions x 28 compact series serialized frame低於16MiB；working set上限4000；exact package、WebSharper、F# Playwright與Playwright MCP無OOM/console error。 | Partial：deterministic contract容量、五專案full build、public NuGet exact dependency readback及generic F# Playwright desktop/mobile已Pass；待Daedalus real MDCQ/DIB 3820x28與Playwright MCP。 |
