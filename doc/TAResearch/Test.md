...
| DYN-TA-T-070 | REQ-050 | Capacity/package/browser | 3820 positions x 28 compact series serialized frame低於16MiB；working set上限4000；exact package、WebSharper、F# Playwright與Playwright MCP無OOM/console error。 | Partial：deterministic frame與generic BrowserDemo實際3,820×28 state均Pass；Renderer 25/25、Interactive lifecycle 4/4、Ptcs.Client 15/15、F# Playwright及Playwright MCP desktop/mobile無OOM/console error。待Daedalus real MDCQ/DIB 3,820×28 gate。 |
