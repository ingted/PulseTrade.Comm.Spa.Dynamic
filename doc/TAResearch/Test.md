...
| DYN-TA-T-062 | REQ-038..040 | Model/package/Playwright | add/remove/reconfigure不同參數row；pending/reject；1K+5K及5K+30K geometry、missing/partial/final/quality/availability。 | Partial pass：generic isolated Contracts 15/15、Renderer 22/22、PTCS 11/11、Ptcs.Client 13/13；Playwright連續兩次通過desktop/mobile、Add/Edit/reject/remove/reset、shared cursor與console 0。Owner-normalized real DIB evidence併入T-063/064。 |
...
| DYN-TA-T-067 | REQ-038/040 | Contract/renderer/browser | `BaseRowId`指定shared event-time axis；cursor落base真實datapoint，其他row只呈現containing/as-of/missing；`VisibleRangeChanged`具correlation、expected revision與`MaximumBasePoints <= 4000`。 | Planned：DYN-TA-017G phase 2。 |
