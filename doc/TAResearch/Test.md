...
| DYN-TA-T-010 | REQ-011/012 | PTCS E2E | 500+ bars + 20 polls update revision only；message/PCSL/IndexedDB history count stable | DYN-TA-004/006 | Partial：PTCS beta82 real transient no-history gate pass；Dynamic.Ptcs alpha4 bounded wire與Ptcs.Client alpha5 scheduler已編譯，500 bars/20 polls真host Playwright仍待。 |
...
| DYN-TA-T-013 | REQ-017 | Contract parity | PTCS/E2EQ adapters produce identical final reducer state | DYN-TA-004/005 | Partial：Dynamic.Ptcs alpha4使用canonical reducer、legacy/browser wire、完整status vocabulary與session isolation 4/4 pass；Ptcs.Client alpha5 projection/action/lifecycle tests 4/4；E2EQ adapter待補。 |
