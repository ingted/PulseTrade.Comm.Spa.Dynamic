...
| DYN-TA-T-103 | DYN-WBS-562 | Snapshot ordered-stream decoder | machine consumer以owner `decodeFrames`讀legacy＋多batchordered wire；partial/interleaved/orphan/schema/kind/malformed/generation回global index；browser commit不重做full validation。 | OWNER PASS：Contracts 41/41，完整graph focused `41/46/12/14/16`；F# Playwright five-candle 67.28ms、scenario 79.81ms、全部acceptance phase over100=0；local packages待Daedalus consumer gate。 |
