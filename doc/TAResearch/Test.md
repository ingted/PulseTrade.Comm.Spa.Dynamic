...
| DYN-TA-T-069 | REQ-048/049 | Contract/reducer/wire/renderer | sparse shared axis與scalar series roundtrip；preview同Position revision替換；missing/malformed axis、revision mismatch與unknown Position fail closed；PTCS v5不展開legacy points；五scalar candle join不補gap。 | Pass：Contracts 19/19、Renderer 25/25、PTCS 13/13、Ptcs.Client 15/15。 |
