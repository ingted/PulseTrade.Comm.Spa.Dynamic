...
| DYN-TA-T-094 | RFC-0022 | Renderer model | 四種label可見文字、相鄰X區間collision lane、left/right clamp、row-edge反向展開、blank/long label；Y-domain與row height不變。 | PASS：Renderer exact package 39/39。 |
...
| DYN-TA-T-097 | RFC-0022 | Performance/package/consumer | 4,000 bars、300 transitions p95<125/max<400、無HTTP/重建/>100ms owner task；exact package與SPAA/DIB handoff。 | PASS（owner）：3,820 bars、All 179ms、pointer p95 27.48ms/max 64ms；三包exact tests與bundle contract通過，已交Daedalus跑真SPAA。 |
