...
| `DYN-TA-T-063..064` | `DYN-TA-017E..F` | ColdFar Notebook `dotnet dib` fixture及Playwright MCP real-path matrix；Daedalus SessionHost、MDCQ provider identity/cursor與resource lifecycle是production gate。 |
