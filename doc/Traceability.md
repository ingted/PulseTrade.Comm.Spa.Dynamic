...
| `DYN-TA-T-063..064` | `DYN-TA-017E..F` | ColdFar Notebook `dotnet dib` fixture及Playwright MCP real-path matrix；Contracts alpha15 / Renderer alpha37 / Interactive.Client alpha8以exact `FSharp.Core [10.1.302]`解除Daedalus restore blocker，SessionHost、MDCQ provider identity/cursor與resource lifecycle仍是production gate。 |
