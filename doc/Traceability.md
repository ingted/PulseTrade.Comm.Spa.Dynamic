...
| `DYN-T-545..555` | `DYN-WBS-538..542` | Marker v2 correction owner gates：accepted RFC、v1/v2 codec、cache schema 3、direction/hollow/shared cursor、bucket/aggregate lanes、exact clients與F# Playwright browser evidence。Daedalus真SPAA/Notebook另由external handoff驗收。 |
