...
| `DYN-TA-T-063..064` | `DYN-TA-017E..F` | ColdFar Notebook `dotnet dib` fixture及Playwright MCP real-path matrix；production相容組為Contracts alpha16 / Renderer alpha38 / Interactive.Client alpha9，全部exact `FSharp.Core [10.1.400]`，SessionHost、MDCQ provider identity/cursor與resource lifecycle仍是Daedalus production gate。 |
