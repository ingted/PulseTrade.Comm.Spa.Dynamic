...
| DYN-T-616 | Marker OFI projection | plot無inline marker label；glyph/title保留；24px OFI位於cursor gutter與plot間；single、dense64顯示4＋`+60`、empty slot維持空白高度；tooltip/排序穩定 | PASS：Renderer 48/48及F# Playwright通過。 |
...
| DYN-T-618 | Exact package/consumer | `0.1.29 / 0.1.74 / 0.1.65` full WebSharper build、focused tests、bundle manifest／dependency／SHA；Daedalus真SPAA clean-cache驗收後public push | OWNER PASS／consumer pending：48/48、12/12、package verifier及owner browser gate通過；未public push。 |
