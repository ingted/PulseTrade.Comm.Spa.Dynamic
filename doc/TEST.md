...
| DYN-T-619 | PTCS adapter exact graph | Dynamic.Ptcs exact PTCS `[0.2.46]`／Contracts `[0.1.29]`；Ptcs.Client再exact Renderer `[0.1.76]`；adapter focused suites與LiveDemo full WebSharper build；package/AssemblyVersion/dependencies一致 | OWNER PASS／release pending：Dynamic.Ptcs `0.1.50` 14/14、Ptcs.Client `0.1.77` 16/16、LiveDemo Release build 0 errors；local nupkg identity/dependencies通過。 |
